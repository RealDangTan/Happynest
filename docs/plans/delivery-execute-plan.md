...
| **P1.4** | T2 | Cải tiến FE-03b theo feedback owner 2026-08-25: cột bật/tắt localStorage; registry nguồn BE nhẹ (`sources` + GET/POST/PATCH) + wizard đăng ký; import CSV map cột + preview (decisions cùng ngày là phê duyệt) | [FE-03b-source-columns-csv-map.md](FE-03b-source-columns-csv-map.md) — session FE làm NGAY sau FE-03, trước FE-04 | FE | Bảng tuỳ biến cột; đăng ký nguồn mới qua wizard; import CSV cột lệch tên vẫn vào đúng trường | ☐ |
