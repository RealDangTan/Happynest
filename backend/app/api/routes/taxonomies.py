...
def review_theme(
    ...
    if body.action == "approve":
        return TaxonomyOut.model_validate(taxonomy_service.approve_theme(session, theme))

    if body.action == "reject":
        return TaxonomyOut.model_validate(taxonomy_service.reject_theme(session, theme))
    ...
    return TaxonomyOut.model_validate(taxonomy_service.merge_theme(session, theme, target))
