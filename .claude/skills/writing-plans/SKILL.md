...
**Save plans to:** `docs/plans/` (this repo's convention — numbered phase files indexed by `docs/plans/00-index.md`; user preferences override).
...
**"Plan complete and saved to `docs/plans/<filename>.md`. Execution in this repo is INLINE (no subagents — limited LLM API credit).**
